...
public class MyAdapterCart extends RecyclerView.Adapter {
    ArrayList Products;
    Context context;
    ...
    public MyAdapterCart(Context context, ArrayList Prod) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        ((MyViewHolder) holder).cancelC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                int j = 0;
                while (ProductsCart.size() > j) {

                    if(((MyViewHolder) holder).currentProd.getName().equals(ProductsCart.get(j).name)){
                        ProductsCart.remove(j);
                    }
                    else {
                        j++;
                    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder  {
        ...
        public MyViewHolder(final View itemView) {
            ...
            cancelC = itemView.findViewById(R.id.cancel);
